...
insert into publisher values(2, 'GCP', 'USA');
insert into publisher values(2, 'Avery', 'USA');
insert into publisher values(2, 'Del Rey', 'UK');
insert into publisher values(2, 'Vintage', 'UK');

-- to insert into books table
...
-- to insert into books_subjects table
